...
interface CreatorGameLobbyPageProps {
  params: {
    id: string
  }
}

export default function CreatorGameLobbyPage({ params }: CreatorGameLobbyPageProps) {
  return <GameLobby userType="creator" game={mockGame} rounds={mockRounds} leaderboard={mockLeaderboard} />
}
